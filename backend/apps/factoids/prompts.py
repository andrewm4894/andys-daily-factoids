...
def build_factoid_generation_prompt(
    ...
    # Main instruction
    if topic:
        instruction = f"Please provide a new, concise, interesting fact about {topic} in one sentence, along with its subject and an emoji that represents the fact."
    else:
        instruction = "Please provide a new, concise, interesting fact in one sentence, along with its subject and an emoji that represents the fact."
