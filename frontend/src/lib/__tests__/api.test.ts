...
describe('Factoid API Functions', () => {
  ...
  describe('fetchFactoidById', () => {
    it('should fetch a specific factoid by ID', async () => {
      ...
      mockFetch.mockResolvedValueOnce(createMockResponse(mockFactoid) as any)
    ...
    it('should handle not found errors', async () => {
      ...
      mockFetch.mockResolvedValueOnce(notFoundResponse as any)
  ...
  describe('generateFactoid', () => {
    ...
    it('should handle rate limit errors', async () => {
      const rateLimitResponse = {
        ...
        text: () => Promise.resolve(JSON.stringify({ detail: 'Rate limit exceeded', retry_after: 60 })),
      }
  ...
  describe('submitFeedback', () => {
    it('should submit feedback with minimal data', async () => {
      mockFetch.mockResolvedValueOnce(createMockResponse(null, 201) as any)
  ...
  describe('fetchRateLimitStatus', () => {
    it('should fetch rate limit status', async () => {
      ...
      mockFetch.mockResolvedValueOnce(createMockResponse(mockStatus) as any)
...
describe('Payment API Functions', () => {
  ...
  describe('createCheckoutSession', () => {
    it('should create checkout session with minimal parameters', async () => {
      ...
      mockFetch.mockResolvedValueOnce(createMockResponse(mockResponse) as any)
