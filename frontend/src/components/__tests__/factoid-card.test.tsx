...
const mockSubmitFeedback = api.submitFeedback as jest.MockedFunction<typeof api.submitFeedback>
...
describe('FactoidCard', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render factoid text, emoji, and basic info', () => {
      ...
      expect(screen.getByText(/This is a fascinating fact/)).toBeInTheDocument()
    })
    ...
    it('should show full text and voting buttons when initially expanded', () => {
      ...
      expect(screen.getByText(/This is a fascinating fact about the universe that will blow your mind and make you think\./)).toBeInTheDocument()
  ...
  describe('Card Expansion', () => {
    ...
    it('should collapse when clicked again', async () => {
      ...
      const card = screen.getByRole('button', { name: /This is a fascinating fact/ })
      fireEvent.click(card)
  ...
  describe('Copy Functionality', () => {
    ...
    it('should handle clipboard API failures gracefully', async () => {
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Failed to copy factoid', expect.any(Error))
      })
  ...
  describe('Google Search', () => {
    it('should open Google search in new window', () => {
      ...
      const searchButton = screen.getByLabelText('Search this factoid on Google')
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper button labels', () => {
      ...
      expect(screen.getByLabelText('Copy link to this factoid')).toBeInTheDocument()
      expect(screen.getByLabelText('Chat about this factoid')).toBeInTheDocument()
      expect(screen.getByLabelText('Search this factoid on Google')).toBeInTheDocument()
    })
  })

  describe('Text Truncation Logic', () => {
    it('should deterministically truncate based on factoid ID', () => {
      const longText = 'This is a very long factoid text that should definitely be truncated because it has many many words in it and goes on and on'
      ...
      const truncated2 = screen.getByText(/This is a very.*…/)
